...
ARCHBANG_APPS="vmtouch catfish reflector lxterminal lxappearance lxappearance-obconf lxinput leafpad gucharmap pcmanfm galculator parcellite xarchiver shotwell htop arandr tint2 conky xcompmgr nitrogen scrot exo gnome-mplayer xfburn libfm-gtk2 gmrun slim packer arj cronie dialog dnsutils gnome-keyring gsimplecal gtk-engine-murrine gtk-engines inetutils jfsutils logrotate lzop memtest86+ modemmanager ntfs-3g p7zip rsync squashfs-tools syslinux tcl unrar unzip usb_modeswitch zip gvfs cbatticon xdg-utils pv nfs-utils glxinfo speech-dispatcher unclutter xdotool inotify-tools"
...
NETWORK="network-manager-applet broadcom-wl-dkms xfce4-notifyd"
BROWSER="firefox"
